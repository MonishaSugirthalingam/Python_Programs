...
tol_tax_amount={"Product TYpe":["Electronic accessories","Fashion accessories","Food and beverages","Health and beauty","Home and lifestyle","Sports and travel"],"Total Tax amount":[tax_Electronic_accessories,tax_Fashion_accessories,tax_Food_and_beverages,tax_Health_and_beauty,tax_Home_and_lifestyle,tax_Sports_and_travel]}
print(pd.DataFrame(tol_tax_amount))
print("-"*20)
